...
use crate::lang_lua::primitives::TemplateContextRef;
...
impl SettingView for LuaSettingExecutor {
    async fn view<'a>(
        ...
        .into_response::<Vec<indexmap::IndexMap<String, splashcore_rs::value::Value>>>()
        .map_err(|e| SettingsError::Generic {
            message: e.to_string(),
            src: "LuaSettingExecutor".to_string(),
...
impl SettingCreator for LuaSettingExecutor {
    async fn create<'a>(
        ...
        .into_response::<indexmap::IndexMap<String, splashcore_rs::value::Value>>()
        .map_err(|e| SettingsError::Generic {
            message: e.to_string(),
            src: "LuaSettingExecutor".to_string(),
            typ: "internal#to_response".to_string(),
    ...
    async fn delete<'a>(
        ...
        if !result {
            return Err(SettingsError::Generic {
                message: "No records have been deleted by the template.".to_string(),
                src: "LuaSettingExecutor".to_string(),
                typ: "template#no_records_deleted".to_string(),
            });
        }
