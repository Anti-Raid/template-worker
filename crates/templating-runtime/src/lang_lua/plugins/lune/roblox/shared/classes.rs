...
use crate::lang_lua::plugins::lune::roblox::instance::Instance;
...
pub(crate) fn add_class_restricted_getter<F: LuaUserDataFields<Instance>, R, G>(
    ...
    R: IntoLua,
    G: 'static + std::marker::Send + Fn(&Lua, &Instance) -> LuaResult<R>,
{
...
pub(crate) fn add_class_restricted_setter<F: LuaUserDataFields<Instance>, A, G>(
    ...
    A: FromLua,
    G: 'static + std::marker::Send + Fn(&Lua, &Instance, A) -> LuaResult<()>,
{
...
pub(crate) fn add_class_restricted_method<M: LuaUserDataMethods<Instance>, A, R, F>(
    ...
    A: FromLuaMulti,
    R: IntoLuaMulti,
    F: 'static + std::marker::Send + Fn(&Lua, &Instance, A) -> LuaResult<R>,
{
...
pub(crate) fn add_class_restricted_method_mut<M: LuaUserDataMethods<Instance>, A, R, F>(
    ...
    A: FromLuaMulti,
    R: IntoLuaMulti,
    F: 'static + std::marker::Send + Fn(&Lua, &mut Instance, A) -> LuaResult<R>,
{
