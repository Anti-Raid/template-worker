...
impl<'lua> LuaExportsTable<'lua> for Color3 {
    ...
    fn create_exports_table(lua: &'lua Lua) -> LuaResult<LuaTable> {
        TableBuilder::new(lua)?
            .with_function(
                "fromRGB",
                |_, (r, g, b): (Option<u8>, Option<u8>, Option<u8>)| {
                    Ok(Color3 {
            ...
            .with_function("fromHSV", |_, (h, s, v): (f32, f32, f32)| {
            ...
            .with_function("fromHex", |_, hex: String| {
            ...
            .with_function(
                "new",
                |_, (r, g, b): (Option<f32>, Option<f32>, Option<f32>)| {
                    Ok(Color3 {
