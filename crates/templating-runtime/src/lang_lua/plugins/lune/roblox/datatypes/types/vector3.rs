...
use crate::lang_lua::plugins::lune::roblox::{
    datatypes::util::round_float_decimal, exports::LuaExportsTable,
};
...
impl<'lua> LuaExportsTable<'lua> for Vector3 {
    ...
    fn create_exports_table(lua: &'lua Lua) -> LuaResult<LuaTable> {
        TableBuilder::new(lua)?
            ...
            .with_function("fromAxis", |_, normal_id: LuaUserDataRef<EnumItem>| {
            ...
            .with_function("fromNormalId", |_, normal_id: LuaUserDataRef<EnumItem>| {
