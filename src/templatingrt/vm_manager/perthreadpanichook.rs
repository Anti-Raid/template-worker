// https://docs.rs/thread-local-panic-hook/latest/src/thread_local_panic_hook/panic.rs.html#24-30
...
thread_local! {
    static PANIC_HOOK: RefCell<Option<Hook>> = const { RefCell::new(None) };
}
